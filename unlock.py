...
def argParse():
    ...
    parser.add_argument("-d", "--xlsx-dir", dest="xlsx_dir", type=str, required=True)
    parser.add_argument("-p", "--pass", dest="password", type=str, required=True)
...
if __name__ == "__main__":
    args = argParse()
    unlock(password=args.password, xlsx_dir=args.xlsx_dir)
